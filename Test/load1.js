...
document.getElementById('save').addEventListener('click', function() {
    ...
    /*    var line = new Kinetic.Line({
        points: [0, 0, document.getElementById(c).offsetWidth,0],
        stroke: 'black',
        strokeWidth: 5,
        // lineCap: 'round',
        // lineJoin: 'round'
        ...
        var line = new Kinetic.Line({
        points: [0, 0, 0,document.getElementById(c).offsetWidth],
        stroke: 'black',
        strokeWidth: 5,
        // lineCap: 'round',
        // lineJoin: 'round'
        ...
        var line = new Kinetic.Line({
        points: [0, document.getElementById(c).offsetWidth,document.getElementById(c).offsetWidth,document.getElementById(c).offsetWidth],
        stroke: 'black',
        strokeWidth: 5,
        // lineCap: 'round',
        // lineJoin: 'round'
        ...
        var line = new Kinetic.Line({
        points: [document.getElementById(c).offsetWidth,0,document.getElementById(c).offsetWidth,document.getElementById(c).offsetWidth,],
        stroke: 'black',
        strokeWidth: 5,
        // lineCap: 'round',
        // lineJoin: 'round'
